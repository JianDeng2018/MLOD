...
class EvaluationTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.test_points = np.array([[-39.99, 4.99, 0], [39.99, 4.99, 0],
                                    [-39.99, -4.99, 0], [39.99, -4.99, 0],
                                    [-39.99, 4.99, 69.99], [39.99, 4.99, 69.99],
                                    [-39.99, -4.99, 69.99], [39.99, -4.99, 69.99],
                                    [-39.99, 4.99, 69.99], [39.99, 4.99, 69.99],
                                    [-39.99, -4.99, 69.99], [39.99, -4.99, 69.99]])

        # Expected leaf layout for voxelization at size 0.1
        filled_indices = np.floor((cls.test_points * 10) + [400, 50, 0]).astype(np.int32)
