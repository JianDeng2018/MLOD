"""Tests for mlod.core.models.mlod_model"""

import numpy as np
import tensorflow as tf

import mlod
import mlod.builders.config_builder_util as config_build
...
from mlod.protos import pipeline_pb2


class MlodModelTest(tf.test.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_mlod_loss_correct_class_mask(self):
