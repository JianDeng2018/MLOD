...
def object_label_to_box_2d(obj_label):
    """Turns an ObjectLabel into an box_2d

    Args:
        obj_label: ObjectLabel

    Returns:
        anchor: 2D box in box_2d format [x1, y1, x2, y2]
    """
    ...
    box_2d[0] = obj_label.x1
    box_2d[1] = obj_label.y1
    box_2d[2] = obj_label.x2 
    box_2d[3] = obj_label.y2 
