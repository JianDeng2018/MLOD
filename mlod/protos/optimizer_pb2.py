...
# source: mlod/protos/optimizer.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlod/protos/optimizer.proto',
  package='mlod.protos',
  syntax='proto2',
  serialized_pb=_b('\n\x1bmlod/protos/optimizer.proto\x12\x0bmlod.protos\"\xd4\x02\n\tOptimizer\x12;\n\x12rms_prop_optimizer\x18\x01 \x01(\x0b\x32\x1d.mlod.protos.RMSPropOptimizerH\x00\x12<\n\x12momentum_optimizer\x18\x02 \x01(\x0b\x32\x1e.mlod.protos.MomentumOptimizerH\x00\x12\x34\n\x0e\x61\x64\x61m_optimizer\x18\x03 \x01(\x0b\x32\x1a.mlod.protos.AdamOptimizerH\x00\x12\x41\n\x10gradient_descent\x18\x06 \x01(\x0b\x32%.mlod.protos.GradientDescentOptimizerH\x00\x12 \n\x12use_moving_average\x18\x04 \x01(\x08:\x04true\x12$\n\x14moving_average_decay\x18\x05 \x01(\x02:\x06\x30.9999B\x0b\n\toptimizer\"\x93\x01\n\x10RMSPropOptimizer\x12\x30\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x19.mlod.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\x12\x12\n\x05\x64\x65\x63\x61y\x18\x03 \x01(\x02:\x03\x30.9\x12\x12\n\x07\x65psilon\x18\x04 \x01(\x02:\x01\x31\"l\n\x11MomentumOptimizer\x12\x30\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x19.mlod.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\"A\n\rAdamOptimizer\x12\x30\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x19.mlod.protos.LearningRate\"L\n\x18GradientDescentOptimizer\x12\x30\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x19.mlod.protos.LearningRate\"\x84\x02\n\x0cLearningRate\x12\x43\n\x16\x63onstant_learning_rate\x18\x01 \x01(\x0b\x32!.mlod.protos.ConstantLearningRateH\x00\x12T\n\x1f\x65xponential_decay_learning_rate\x18\x02 \x01(\x0b\x32).mlod.protos.ExponentialDecayLearningRateH\x00\x12H\n\x19manual_step_learning_rate\x18\x03 \x01(\x0b\x32#.mlod.protos.ManualStepLearningRateH\x00\x42\x0f\n\rlearning_rate\"4\n\x14\x43onstantLearningRate\x12\x1c\n\rlearning_rate\x18\x01 \x01(\x02:\x05\x30.002\"\x97\x01\n\x1c\x45xponentialDecayLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12\x1c\n\x0b\x64\x65\x63\x61y_steps\x18\x02 \x01(\r:\x07\x34\x30\x30\x30\x30\x30\x30\x12\x1a\n\x0c\x64\x65\x63\x61y_factor\x18\x03 \x01(\x02:\x04\x30.95\x12\x17\n\tstaircase\x18\x04 \x01(\x08:\x04true\"\xce\x01\n\x16ManualStepLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12J\n\x08schedule\x18\x02 \x03(\x0b\x32\x38.mlod.protos.ManualStepLearningRate.LearningRateSchedule\x1a\x42\n\x14LearningRateSchedule\x12\x0c\n\x04step\x18\x01 \x01(\r\x12\x1c\n\rlearning_rate\x18\x02 \x01(\x02:\x05\x30.002')
)
...
_OPTIMIZER = _descriptor.Descriptor(
  name='Optimizer',
  full_name='mlod.protos.Optimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rms_prop_optimizer', full_name='mlod.protos.Optimizer.rms_prop_optimizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer', full_name='mlod.protos.Optimizer.momentum_optimizer', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adam_optimizer', full_name='mlod.protos.Optimizer.adam_optimizer', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gradient_descent', full_name='mlod.protos.Optimizer.gradient_descent', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_moving_average', full_name='mlod.protos.Optimizer.use_moving_average', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='moving_average_decay', full_name='mlod.protos.Optimizer.moving_average_decay', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='optimizer', full_name='mlod.protos.Optimizer.optimizer',
...
_RMSPROPOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.RMSPropOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.RMSPropOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='mlod.protos.RMSPropOptimizer.momentum_optimizer_value', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decay', full_name='mlod.protos.RMSPropOptimizer.decay', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='mlod.protos.RMSPropOptimizer.epsilon', index=3,
...
_MOMENTUMOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.MomentumOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.MomentumOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='mlod.protos.MomentumOptimizer.momentum_optimizer_value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.9),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADAMOPTIMIZER = _descriptor.Descriptor(
  name='AdamOptimizer',
  full_name='mlod.protos.AdamOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.AdamOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GRADIENTDESCENTOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.GradientDescentOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.GradientDescentOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LEARNINGRATE = _descriptor.Descriptor(
  name='LearningRate',
  full_name='mlod.protos.LearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='constant_learning_rate', full_name='mlod.protos.LearningRate.constant_learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='exponential_decay_learning_rate', full_name='mlod.protos.LearningRate.exponential_decay_learning_rate', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='manual_step_learning_rate', full_name='mlod.protos.LearningRate.manual_step_learning_rate', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='learning_rate', full_name='mlod.protos.LearningRate.learning_rate',
      index=0, containing_type=None, fields=[]),
  ],
...
_CONSTANTLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.ConstantLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.ConstantLearningRate.learning_rate', index=0,
...
_EXPONENTIALDECAYLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.ExponentialDecayLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='mlod.protos.ExponentialDecayLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='decay_steps', full_name='mlod.protos.ExponentialDecayLearningRate.decay_steps', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decay_factor', full_name='mlod.protos.ExponentialDecayLearningRate.decay_factor', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='staircase', full_name='mlod.protos.ExponentialDecayLearningRate.staircase', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANUALSTEPLEARNINGRATE_LEARNINGRATESCHEDULE = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.ManualStepLearningRate.LearningRateSchedule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='step', full_name='mlod.protos.ManualStepLearningRate.LearningRateSchedule.step', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='mlod.protos.ManualStepLearningRate.LearningRateSchedule.learning_rate', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANUALSTEPLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='mlod.protos.ManualStepLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='mlod.protos.ManualStepLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='schedule', full_name='mlod.protos.ManualStepLearningRate.schedule', index=1,
...
Optimizer = _reflection.GeneratedProtocolMessageType('Optimizer', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.Optimizer)
  ))
...
RMSPropOptimizer = _reflection.GeneratedProtocolMessageType('RMSPropOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.RMSPropOptimizer)
  ))
...
MomentumOptimizer = _reflection.GeneratedProtocolMessageType('MomentumOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.MomentumOptimizer)
  ))
...
AdamOptimizer = _reflection.GeneratedProtocolMessageType('AdamOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.AdamOptimizer)
  ))
...
GradientDescentOptimizer = _reflection.GeneratedProtocolMessageType('GradientDescentOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.GradientDescentOptimizer)
  ))
...
LearningRate = _reflection.GeneratedProtocolMessageType('LearningRate', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.LearningRate)
  ))
...
ConstantLearningRate = _reflection.GeneratedProtocolMessageType('ConstantLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.ConstantLearningRate)
  ))
...
ExponentialDecayLearningRate = _reflection.GeneratedProtocolMessageType('ExponentialDecayLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.ExponentialDecayLearningRate)
  ))
...
ManualStepLearningRate = _reflection.GeneratedProtocolMessageType('ManualStepLearningRate', (_message.Message,), dict(
  ...
  LearningRateSchedule = _reflection.GeneratedProtocolMessageType('LearningRateSchedule', (_message.Message,), dict(
    ...
    __module__ = 'mlod.protos.optimizer_pb2'
    # @@protoc_insertion_point(class_scope:mlod.protos.ManualStepLearningRate.LearningRateSchedule)
    ))
  ,
  DESCRIPTOR = _MANUALSTEPLEARNINGRATE,
  __module__ = 'mlod.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:mlod.protos.ManualStepLearningRate)
  ))
